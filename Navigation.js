    ...
    return (
        <Tab.Navigator
            ...
            screenOptions={{
                ...
                tabBarInactiveBackgroundColor: '#e0cdb6',
                tabBarActiveBackgroundColor: '#e0cdb6',
                tabBarStyle: {
                    height: 60,
                    borderColor: "#e0cdb6",
                    borderWidth: 3,
                ...
                <Tab.Screen 
                    ...
                    options={{
                        ...
                        tabBarIcon: ({ color, size }) => (
                            <Entypo name="home" size={24} color="#4f4846" />
                        ),
                        headerShown: false,
                    }}
                />
            ...
            {userType !== "empresa" && (
                <Tab.Screen 
                    ...
                    options={{
                        tabBarLabel: 'Home',
                        tabBarIcon: ({ color, size }) => (
                            <Ionicons name="home" size={24} color="#4f4846" />
                        ),
                        headerShown: false,
                    }}
                />
            ...
            {userType === "usuario" && (
                <Tab.Screen 
                    ...
                    options={{
                        tabBarLabel: 'Perfil',
                        tabBarIcon: ({ color, size }) => (
                            <FontAwesome6 name="user-large" size={24} color="#4f4846" />
                        ),
                        headerShown: false,
                    }}
                />
            ...
            {userType === "usuario" && (
                <Tab.Screen 
                    ...
                    options={{
                        tabBarLabel: 'Citas',
                        tabBarIcon: ({ color, size }) => (
                            <Ionicons name="calendar" size={24} color="#4f4846" />
                        ),
                        headerShown: false,
                    }}
                />
